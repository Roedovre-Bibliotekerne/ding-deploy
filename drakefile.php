...
/**
 * @file
 * Drakefile for Rødovre Bibliotek. Requires drake_reload.
 *
...
$drake_reload = array(
  'core' => '6.x',
  'site_name' => 'Rødovre Bibliotek',
  'type' => 'ding',
  'ding_url' => 'git@github.com:Roedovre-Bibliotekerne/ding-deploy.git',
  'envs' => array(
    'prod' => array(
      'alias' => '@r.rdb.prod',
      'name' => 'Prod',
...
$context = array(
  ...
  'repository' => 'git@github.com:Roedovre-Bibliotekerne/ding-deploy.git',
);
...
$tasks['sanitize-drush'] = array(
  ...
  'commands' => array(
    ...
    array(
      'command' => 'vset',
      'args' => array('site_name', 'Rødovre Bibliotek ' . php_uname('n')),
    ),
  ),
);
